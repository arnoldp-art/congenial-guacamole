...
export const MAPS: HistoricalMap[] = [
  {
    ...
    blurb: "Mechelen is at the heart of the Habsburg Low Countries — a dense medieval city of beguinages, guild halls and Sint-Romboutskathedraal, enclosed within earthwork defences.",
    type: 'xyz',
    url: DV('frickx'),
  ...
  },
  {
    ...
    blurb: "The first scientific survey of the Austrian Netherlands reveals Mechelen's ring of monastic gardens and canal-side industry. The city walls remain but are increasingly decorative rather than defensive.",
    type: 'xyz',
    url: DV('ferraris'),
  ...
  },
  {
    ...
    blurb: "Belgium's first railway (Brussels–Mechelen, 1835) is already visible cutting through the southern suburbs. The Atlas captures the city just as the industrial age begins to reshape it.",
    type: 'xyz',
    url: DV('abw'),
  ...
  },
  {
    ...
    blurb: "Belgium's first national topographic map shows Mechelen adapting to industrialisation — textile mills and metalworks multiply along the Dijle, and the station is already a focal point.",
    type: 'xyz',
    url: DV('vandermaelen'),
  ...
  },
  {
    ...
    blurb: "Parcel-by-parcel cadastral detail reveals rapid densification inside the old rampart line as the furniture and brewery industries expand and workers' housing fills former monastic plots.",
    type: 'xyz',
    url: DV('popp'),
  ...
  },
  {
    ...
    blurb: "The old city walls have been demolished and replaced by ring roads and public parks — a pattern repeated across 19th-century Europe. The railway workshops are now among Mechelen's largest employers.",
    type: 'xyz',
    url: NGI_TOPO('140'),
  ...
  },
  {
    ...
    blurb: "Peak industrial Mechelen — a major railway hub and furniture-manufacturing centre. Tram lines radiate outward and the first workers' suburbs spread beyond the historic core.",
    type: 'xyz',
    url: NGI_TOPO('450'),
    attribution: '© NGI/IGN Belgium',
  },
  {
    ...
    blurb: "Inter-war Mechelen shows the first ribbon development along major roads. The historic core is under preservation pressure; new social housing blocks appear on the city edges.",
    type: 'xyz',
    url: NGI_TOPO('800'),
    attribution: '© NGI/IGN Belgium',
  },
  {
    ...
    blurb: "Post-war reconstruction and rapid suburbanisation — several historic streets were widened for traffic. The ring road is bypassing the medieval centre.",
    type: 'xyz',
    url: NGI_TOPO('1100'),
    attribution: '© NGI/IGN Belgium',
  },
  {
    ...
    blurb: "The panchromatic aerial survey captures Mechelen at peak mid-century modernisation — industrial sites dominate the riverfront and open land on the fringe is rapidly disappearing.",
    type: 'xyz',
  ...
  },
  {
    ...
    blurb: "The Dijle riverfront warehouses stand largely derelict as deindustrialisation takes hold. The historic core is beginning its long rehabilitation.",
    type: 'xyz',
    url: NGI_TOPO('1220'),
    attribution: '© NGI/IGN Belgium',
  },
  {
    ...
    blurb: "The late 1980s mark the beginning of Mechelen's urban renaissance — the first conservation areas are designated and the central market square is pedestrianised.",
    type: 'xyz',
    url: NGI_TOPO('1300'),
    attribution: '© NGI/IGN Belgium',
  },
  {
    ...
    blurb: "Colour aerial photography shows a city in transition: closed factories, emerging retail parks, and gradual greening of former industrial land along the river.",
    type: 'xyz',
  ...
  },
  {
    ...
    blurb: "Mechelen's remarkable revival is underway — the Dijle waterfront is transformed into a leisure and residential district, and the cathedral quarter draws tourists.",
    type: 'xyz',
  ...
  },
  {
    ...
    description: '25 cm colour aerial mosaic of Flanders · Digitaal Vlaanderen OMW',
    blurb: "The market square thrives as a leisure hub; historic buildings along the Dijle are converted to restaurants and apartments. The population is growing for the first time in decades.",
    type: 'xyz',
  ...
  },
  {
    ...
    description: '25 cm colour aerial mosaic of Flanders · Digitaal Vlaanderen OMW',
    blurb: "The city's ring of historic monuments — beguinage, Hof van Busleyden, churches — are all restored. New residential development fills the last post-industrial brownfields.",
    type: 'xyz',
  ...
  },
  {
    ...
    description: '25 cm colour aerial mosaic of Flanders · Digitaal Vlaanderen OMW',
    blurb: "Mechelen is consistently rated one of Belgium's best cities to live. The riverfront is unrecognisable from the derelict industrial strip visible in the 1971 aerial.",
    type: 'xyz',
  ...
  },
  {
    ...
    description: '25 cm colour aerial mosaic of Flanders · Digitaal Vlaanderen OMW',
    blurb: "The city centre is virtually car-free and the Dijle quays are lined with terraces. Compare this to the 1971 aerial to see the complete transformation of the urban waterfront.",
    type: 'xyz',
  ...
  },
  {
    ...
    blurb: "Modern Mechelen — a UNESCO World Heritage candidate and showcase of Flemish urban renewal. The railway station is expanding as the city grows again.",
    type: 'xyz',
  ...
  },
  {
    ...
    blurb: "The most recent 15 cm survey captures fine detail of a fully revitalised city: converted warehouses, pedestrian zones, and dense canal-side living.",
    type: 'xyz',
